...
execute unless score #gamemode swrg.math matches 3..4 as @e[type=minecraft:marker,tag=swrg.spawn] at @s run fill ~-1 ~-1 ~-1 ~1 ~4 ~1 minecraft:air
#
schedule clear swrg:game/start/clear
schedule function swrg:game/start/2 5s
execute unless score #gamemode swrg.math matches 3..4 run function swrg:game/chests/fill
