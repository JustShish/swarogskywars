...
data modify storage swrg:lang page1000.s22-0 set value {Name:'{"text":"Бонусы Лаки-Испытаний: ВЫКЛ","color":"white","italic":false}'}
data modify storage swrg:lang page1000.s22-1 set value {Name:'{"text":"Бонусы Лаки-Испытаний: ВКЛ","color":"white","italic":false}'}
