item replace entity @s enderchest.0 with minecraft:brown_concrete[minecraft:custom_name={"color":"aqua","italic":false,"text":"Divine Defecation (8) M"}]
...
item replace entity @s enderchest.7 with minecraft:yellow_terracotta[minecraft:custom_name={"color":"yellow","italic":false,"text":"Highland Peaks (8) M"}]
item replace entity @s enderchest.8 with minecraft:spruce_sapling[minecraft:custom_name={"color":"white","italic":false,"text":"Pavilion (8) M"}]
item replace entity @s enderchest.9 with minecraft:chiseled_sandstone[minecraft:custom_name={"color":"gold","italic":false,"text":"Sand Dunes (4) L"}]
item replace entity @s enderchest.10 with minecraft:coal_block[minecraft:custom_name={"color":"gray","italic":false,"text":"Coalwars (2) XS"}]
