#
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=0},tag=!admin] run scoreboard players add #pvp swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=1},tag=!admin] run scoreboard players add #day swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=2},tag=!admin] run scoreboard players add #gamemode swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=3},tag=!admin] run scoreboard players add #kit swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=4},tag=!admin] run scoreboard players add #skill swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=5},tag=!admin] run scoreboard players add #stage1 swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=6},tag=!admin] run scoreboard players add #stage2 swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=7},tag=!admin] run scoreboard players add #hp swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=8},tag=!admin] run scoreboard players add lefthand swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=9},tag=!admin] run scoreboard players add live_count swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=10},tag=!admin] run scoreboard players add no_borders swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=12},tag=!admin] run scoreboard players add #tnt_resist swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=11},tag=!admin] run scoreboard players add cfg_lucky_modifier swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=13},tag=!admin] run scoreboard players add #lbckit swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=14},tag=!admin] run scoreboard players add #lbcskill swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=15},tag=!admin] run scoreboard players add #lbclevelup swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=16},tag=!admin] run scoreboard players add #lbclevelupmax swrg.math 1
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=25},tag=!admin] run scoreboard players set @s swrg.gui_page 1100
...
execute unless entity @a[tag=admin] if entity @s[scores={swrg.gui_select=26},tag=!admin] run function swrg:core/default_settings
