...
data modify entity @s FireworksItem.components.minecraft:fireworks.explosions[0].colors set value [I;0]
...
scoreboard players set #random_max swrg.math 16777216
function swrg:core/get_random
data modify entity @s FireworksItem.components.minecraft:fireworks.explosions[1].colors set value [I;0]
...
scoreboard players set #random_max swrg.math 16777216
function swrg:core/get_random
data modify entity @s FireworksItem.components.minecraft:fireworks.explosions[].fade_colors set value [I;0]
