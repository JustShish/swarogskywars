...
execute if score @s swrg.roll matches 1 run scoreboard players remove @s swrg.keys1 1
#
execute if score @s swrg.roll matches 1 run function swrg:gui/roll/fill1
#
