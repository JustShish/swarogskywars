item replace entity @s enderchest.0 with minecraft:netherrack[minecraft:custom_name={"color":"aqua","italic":false,"text":"Hell (8)"}]
item replace entity @s enderchest.1 with minecraft:jungle_log[minecraft:custom_name={"color":"aqua","italic":false,"text":"Jungle (8)"}]
item replace entity @s enderchest.2 with minecraft:jungle_leaves[minecraft:custom_name={"color":"aqua","italic":false,"text":"Monkeys (8)"}]
item replace entity @s enderchest.3 with minecraft:map[minecraft:custom_name={"color":"aqua","italic":false,"text":"Oasis (8)"}]
item replace entity @s enderchest.4 with minecraft:lily_pad[minecraft:custom_name={"color":"aqua","italic":false,"text":"Swamp (8)"}]
