...
execute if entity @s[tag=admin,scores={swrg.gui_select=0}] run scoreboard players add #pvp swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=1}] run scoreboard players add #day swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=4}] run scoreboard players add #skill swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=5}] run scoreboard players add #stage1 swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=6}] run scoreboard players add #stage2 swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=7}] run scoreboard players add #hp swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=8}] run scoreboard players add lefthand swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=9}] run scoreboard players add live_count swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=10}] run scoreboard players add no_borders swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=12}] run scoreboard players add #tnt_resist swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=11}] run scoreboard players add cfg_lucky_modifier swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=13}] run scoreboard players add #lbckit swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=14}] run scoreboard players add #lbcskill swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=15}] run scoreboard players add #lbclevelup swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=16}] run scoreboard players add #lbclevelupmax swrg.math 1
execute if score #lbclevelupmax swrg.math matches 13.. run scoreboard players set #lbclevelupmax swrg.math 1
...
execute if entity @s[tag=admin,scores={swrg.gui_select=17}] run scoreboard players add #lbctrinket swrg.math 1
execute if score #lbctrinket swrg.math matches 13.. run scoreboard players set #lbctrinket swrg.math 0
