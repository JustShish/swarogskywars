# core
scoreboard objectives add swrg.math dummy
scoreboard players set #100 swrg.math 100
...
scoreboard objectives add swrg.death_effect dummy
...
# stats
scoreboard objectives add swrg.wr dummy
scoreboard objectives add swrg.stat_wins dummy
scoreboard objectives add swrg.stat_kills custom:player_kills
scoreboard objectives add swrg.stat_death deathCount
scoreboard objectives add swrg.stat_games dummy
scoreboard objectives add swrg.kd1.. dummy
scoreboard objectives add swrg.kd..1 dummy