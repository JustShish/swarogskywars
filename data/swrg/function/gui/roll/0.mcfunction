...
execute if score @s swrg.roll matches 1 run scoreboard players remove @s swrg.keys0 1
#
execute if score @s swrg.roll matches 1 run function swrg:gui/roll/fill0
#
execute if score @s swrg.roll matches 1 run function swrg:gui/roll/have1
execute if score @s swrg.roll matches 1 run function swrg:gui/roll/have2
execute if score @s swrg.roll matches 1 run function swrg:gui/roll/have3
#
...
#
execute if score @s swrg.roll matches 22 run function swrg:gui/roll/fill0
#
execute if score @s swrg.roll matches 22 run function swrg:gui/roll/have1
execute if score @s swrg.roll matches 22 run function swrg:gui/roll/have2
execute if score @s swrg.roll matches 22 run function swrg:gui/roll/have3
#
...
execute if score @s swrg.roll matches 25 run function swrg:gui/roll/reward/0
