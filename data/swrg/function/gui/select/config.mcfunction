# pvp
execute if score #pvp swrg.math matches 1 as @a run attribute @s generic.attack_speed base set 100000
execute if score #pvp swrg.math matches 2 as @a run attribute @s generic.attack_speed base set 4
# day time
