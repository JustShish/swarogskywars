item replace entity @s enderchest.0 with light_blue_bed
item replace entity @s enderchest.1 with black_bed
item replace entity @s enderchest.2 with blue_bed
item replace entity @s enderchest.3 with cyan_bed
item replace entity @s enderchest.4 with purple_bed
item replace entity @s enderchest.5 with gray_bed
item replace entity @s enderchest.6 with green_bed
item replace entity @s enderchest.7 with magenta_bed
item replace entity @s enderchest.8 with brown_bed
item replace entity @s enderchest.9 with orange_bed
item replace entity @s enderchest.10 with light_gray_bed
item replace entity @s enderchest.11 with lime_bed
item replace entity @s enderchest.12 with pink_bed
item replace entity @s enderchest.13 with red_bed
item replace entity @s enderchest.14 with white_bed
item replace entity @s enderchest.15 with yellow_bed
