...
#
scoreboard players set @s[scores={swrg.gui_select=18}] swrg.gui_page 7300
scoreboard players set @s[scores={swrg.gui_select=25}] swrg.suffix 0
#scoreboard players set @s[scores={swrg.gui_select=26}] swrg.gui_page 7310
