execute if entity @s[scores={swrg.gui_select=1..25}] unless score @s swrg.gui_select matches 18 run function swrg:maploader/map/alwayspre
...
schedule function swrg:maploader/map_select_imprinted1 2s
schedule function swrg:maploader/map_select_white1 2s
