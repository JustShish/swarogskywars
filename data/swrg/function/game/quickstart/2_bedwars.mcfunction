$function swrg:maploader/map/$(quickstart)b
$execute in minecraft:imprinted run function swrg:maploader/map/$(quickstart)b_broken
$execute in minecraft:white run function swrg:maploader/map/$(quickstart)b
