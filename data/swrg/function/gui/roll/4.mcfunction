...
execute if score @s swrg.roll matches 1 run scoreboard players remove @s swrg.keys4 1
execute if score @s swrg.roll matches 1 run function swrg:gui/roll/fill4
#
execute if score @s swrg.roll matches 1 run function swrg:gui/roll/have4
#
...
#
execute if score @s swrg.roll matches 22 run function swrg:gui/roll/have4
#
...
execute if score @s swrg.roll matches 25 run function swrg:gui/roll/reward/4
