...
execute if score @s swrg.roll matches 1 run scoreboard players remove @s swrg.keys3 1
execute if score @s swrg.roll matches 1 run function swrg:gui/roll/fill3
#
...
#
#execute if score @s swrg.roll matches 22 run function swrg:gui/roll/fill3
#
execute if score @s swrg.roll matches 22 run function swrg:gui/roll/have3
#
execute if score @s swrg.roll matches 2..20 at @s run playsound minecraft:ui.button.click master @s ~ ~ ~ 0.5 1
...
execute if score @s swrg.roll matches 25 run function swrg:gui/roll/reward/3
