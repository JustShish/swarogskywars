...
execute unless score #gamemode swrg.math matches 3..4 run bossbar set swrg:gametimer players @a
# есть первое событие
...
execute unless score #gamemode swrg.math matches 3..4 if score #stage1 swrg.math matches 0 unless score #stage2 swrg.math matches 0 run bossbar set swrg:gametimer visible true
execute unless score #gamemode swrg.math matches 3..4 if score #stage1 swrg.math matches 0 unless score #stage2 swrg.math matches 0 run bossbar set swrg:gametimer max 360
execute unless score #gamemode swrg.math matches 3..4 if score #stage1 swrg.math matches 0 unless score #stage2 swrg.math matches 0 run bossbar set swrg:gametimer color red

execute unless score #gamemode swrg.math matches 3..4 unless score #stage1 swrg.math matches 0 run bossbar set swrg:gametimer max 120

execute unless score #gamemode swrg.math matches 3..4 run schedule function swrg:game/stage1/select 120s
execute unless score #stage2 swrg.math matches 0 unless score #gamemode swrg.math matches 3..4 run schedule function swrg:game/stage2/select 360s
