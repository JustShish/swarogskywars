...
execute as @s[scores={swrg.gui_page=0}] run function swrg:gui/page/0
execute as @s[scores={swrg.gui_page=1000}] run function swrg:gui/page/1000
execute as @s[scores={swrg.gui_page=1100}] run function swrg:gui/page/1100
execute as @s[scores={swrg.gui_page=2000}] run function swrg:gui/page/2000
execute as @s[scores={swrg.gui_page=2100}] run function swrg:gui/page/2100
execute as @s[scores={swrg.gui_page=2200}] run function swrg:gui/page/2200
execute as @s[scores={swrg.gui_page=3000}] run function swrg:gui/page/3000
execute as @s[scores={swrg.gui_page=4000}] run function swrg:gui/page/4000
execute as @s[scores={swrg.gui_page=5000}] run function swrg:gui/page/5000
execute as @s[scores={swrg.gui_page=5100..5400}] run function swrg:gui/page/5000-5400
execute as @s[scores={swrg.gui_page=6000}] run function swrg:gui/page/6000
