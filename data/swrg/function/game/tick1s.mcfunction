...
#
execute as @a[tag=!developer] at @s at @s unless entity @s[x=-192,dx=384,z=-192,dz=384] unless dimension nexus unless score no_borders swrg.math matches 1 run function swrg:core/player/map_out
#